...
public class Demo extends Component implements ActionListener, FocusListener {
    ...
    public BufferedImage SmoothImageConvolution(BufferedImage timg){ //Lab 4 Exercise 1
        ...
        generalCorrelation(result, EdgeDetectionMatrix, matrixConstant);
        return timg;
    }
    public BufferedImage EdgeDetectionConvolution(BufferedImage timg){ //Lab 4 Exercise 2
        ...
        BufferedImage result = timg;
        generalCorrelation(result, EdgeDetectionMatrix);
        return result;
    }

    public BufferedImage generalCorrelation(BufferedImage timg, int[][] filterMaxtrix, float matrixConstant){  //Lab 6 Exercise 1
        int[][][] image1 = convertToArray(timg);
        int height = timg.getHeight();
        int width = timg.getWidth();
        int[][][] image2 = new int[width][height][4];
        int[][] Mask = filterMaxtrix;
        int r,g,b;
    ...
    public BufferedImage generalCorrelation(BufferedImage timg, int[][] filterMaxtrix){  //Lab 6 Exercise 1
        return timg;
    }
