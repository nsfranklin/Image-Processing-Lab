...
public class Demo extends Component implements ActionListener, FocusListener {
    ...
    public int[][][] addImageArrayPadding(int[][][] image){  // extending the board to provide padding.
        ...
        temp[temp[0].length-1][0][1] = image[image[0].length][0][1];
        temp[temp[0].length-1][0][1] = image[image[0].length][0][2];
        temp[temp[0].length-1][0][1] = image[image[0].length][0][3];//top right corner values
